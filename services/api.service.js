...
function getProductsHome(locale) {
  const query = `
    query ProductsHome($locale: SiteLocale) {
...
function getLinesPage(locale) {
  const query = `
    query LinesPage($locale: SiteLocale) {
...
function getOriginsPage(locale) {
  const query = `
    query OriginsPage($locale: SiteLocale) {
...
function getAgingsPage(locale) {
  const query = `
    query AgingsPage($locale: SiteLocale) {
...
function getProductsPage(locale) {
  const query = `
    query ProductsPage($locale: SiteLocale) {
...
function getRecipesPage(locale) {
  const query = `
    query RecipesPage($locale: SiteLocale) {
...
function getLanding(locale, slug) {
  const query = `
    query ProductLineLanding($locale: SiteLocale) {
...
function getRecipeWizard(locale) {
  const query = `
    query RecipeWizard($locale: SiteLocale) {
...
function getCookiePolicyPage(locale) {
  const query = `
    query CookiePolicy($locale: SiteLocale) {
...
function getPrivacyPoliciesPage(locale) {
  const query = `
    query PrivacyPolicies($locale: SiteLocale) {
...
function getSustainabilityPage(locale) {
  const query = `
    query SustainabilityPage($locale: SiteLocale) {
...
function getCompanyStoryPage(locale) {
  const query = `
    query CompanyStoryPage($locale: SiteLocale) {
...
function getCompanyValuesPage(locale) {
  const query = `
    query CompanyValuesPage($locale: SiteLocale) {
...
function getContactsPage(locale) {
  const query = `
    query ContactsPage($locale: SiteLocale) {
